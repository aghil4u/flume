...
class AssetDetailsPhotosTab extends StatefulWidget {
  final String AssetNumberReference;
  AssetDetailsPhotosTab({this.AssetNumberReference});

  _AssetDetailsPhotosTabState createState() =>
      _AssetDetailsPhotosTabState();
}

class _AssetDetailsPhotosTabState
    extends State<AssetDetailsPhotosTab> {
    ...
    rowContents.addAll(<Widget>[
      new IconButton(
        ...
        onPressed: () {
          ...
          Verifications.clear();
          _AssetDetailsPhotosTabState.refreshList(context);
        },
      ),
    ]);
